...
public class Day18SnailFishTests
{
    ...
    public void FinalExample()
    {
        var numbers = new[]
        {
            Number.Parse("[[[0,[5,8]],[[1,7],[9,6]]],[[4,[1,2]],[[1,4],2]]]"),
            Number.Parse("[[[5,[2,8]],4],[5,[[9,9],0]]]"),
            Number.Parse("[6,[[[6,2],[5,6]],[[7,6],[4,7]]]]"),
            Number.Parse("[[[6,[0,7]],[0,9]],[4,[9,[9,0]]]]"),
            Number.Parse("[[[7,[6,4]],[3,[1,3]]],[[[5,5],1],9]]"),
            Number.Parse("[[6,[[7,3],[3,2]]],[[[3,8],[5,7]],4]]"),
            Number.Parse("[[[[5,4],[7,7]],8],[[8,3],8]]"),
            Number.Parse("[[9,3],[[9,9],[6,[4,9]]]]"),
            Number.Parse("[[2,[[7,7],7]],[[5,8],[[9,3],[0,2]]]]"),
            Number.Parse("[[[[5,2],5],[8,[3,7]]],[[5,[7,5]],[4,4]]]"),
        };
        var result = Number.Add(numbers);
    ...
    public void Part2_Example()
    {
        ...
        var result = Number.LargestSum(numbers);
        result.ToString().Should().Be("[[[[7,8],[6,6]],[[6,0],[7,7]]],[[[7,8],[8,8]],[[7,9],[0,6]]]]");
        result.Magnitude().Should().Be(3993);
    }
}