...
{
    [Test]
    public void FindsCorrectNumberOfPathsThroughSampleData()
    {
        var sampleData = new[]
        {
            "start-A",
    ...
    [Test] 
    public void FindsCorrectNumberOfPathsThroughSlightlyLargerSampleData()
    {
        var sampleData = new[]
        {
            "dc-end",
    ...
    [Test] 
    public void FindsCorrectNumberOfPathsThroughEvenLargerSampleData()
    {
        var sampleData = new[]
        {
            "fs-end",
